...
public class CredentialController {
    ...
    public ResponseEntity<List<CredentialDto>> getAllCredentials(
            @RequestParam(value = "id", required = false) final UUID credentialId) throws ResourceNotFoundException {
        try {
                ...
                Credential credential = credentialSvc.get(credentialId)
                        .orElseThrow(() -> new ResourceNotFoundException(
                                "Credential not found for this id :: "
                                        + credentialId));
                CredentialDto credentialDto = mapper.map(credential, CredentialDto.class);
    ...
    public ResponseEntity<CredentialDto> createCredential(
        ...
        CredentialDto response = mapper.map(credentialSvc.save(credential), CredentialDto.class);
    ...
    public ResponseEntity<HttpStatus> deleteCredential(
        ...
        credentialSvc.get(credentialId).orElseThrow(() -> new ResourceNotFoundException(
                "Credential not found for this id to delete :: " + credentialId));
