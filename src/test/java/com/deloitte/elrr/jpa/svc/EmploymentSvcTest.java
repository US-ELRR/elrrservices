...
public class EmploymentSvcTest {
  ...
  void test() {
    ...
    ReflectionTestUtils.setField(employmentSvc, "employmentRepository", employmentRepository);
    Mockito.doReturn(employment).when(employmentRepository).save(employment);
    Mockito.doReturn(true).when(employmentRepository).existsById(1L);
